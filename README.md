...
```javascript
import reviver from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-reviver@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/complex-reviver/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/complex-reviver/actions/workflows/test.yml
